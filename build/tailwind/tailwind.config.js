/* Autogenerated file. Generated at 26/01/2025, 1:12:46 am. Do not edit.*/
  ...
  theme: {
    extend: {
      colors: {
        ...
        progress: {
          bg: "var(--colors-progress-bg)",
          fill: "var(--colors-progress-fill)",
          hover: "var(--colors-progress-hover)",
          success: {
          ...
          warning: {
            bg: "var(--colors-progress-warning-bg)",
            fill: "var(--colors-progress-warning-fill)",
            hover: "var(--colors-progress-warning-hover)",
          },
        },
        white: {
