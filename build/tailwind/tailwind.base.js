/**
 * Autogenerated file. Generated at 2/10/2025, 10:54:16 AM.
 * Do not edit!
 */
  ...
  theme: {
    extend: {
      colors: {
        ...
        state: {
          error: {
            primary: "var(--colors-state-error-primary)"
          },
          warning: {
            primary: "var(--colors-state-warning-primary)"
          },
          info: {
            primary: "var(--colors-state-info-primary)"
          },
          success: {
            primary: "var(--colors-state-success-primary)"
          }
        }
      },
      shadow: {
